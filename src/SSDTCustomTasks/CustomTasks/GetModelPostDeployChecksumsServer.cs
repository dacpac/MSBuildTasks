...
{
    public class GetModelPostDeployChecksumsServer : Task
    {
        [Required]
            ...
            try
            {
                ...
                if (databaseExists)
                {
                    ...
                    if (tableExists)
                    {
                        ...
                        if (ColumnIdExists && ColumnModelChecksumExists && ColumnPostDeployChecksumExists)
                        {
                            string SQLSyntax = @"SELECT TOP 1 [" + ColumnModelChecksumName + "], [" + ColumnPostDeployChecksumName + "] "
                        ...
                        {
                            Log.LogWarning("Column Id, Model Checksum or PostDeploy Checksum Name does not exist, returning -1");
                        }
                        #endregion columns
