...
{
    public class GetModelPreDeployChecksumsServer : Task
    {
        [Required]
            ...
            try
            {
                ...
                if (databaseExists)
                {
                    ...
                    if (tableExists)
                    {
                        ...
                        if (ColumnIdExists && ColumnModelChecksumExists && ColumnPreDeployChecksumExists)
                        {
                            string SQLSyntax = @"SELECT TOP 1 [" + ColumnModelChecksumName + "], [" + ColumnPreDeployChecksumName + "] "
                        ...
                        {
                            Log.LogWarning("Column Id, Model Checksum or PreDeploy Checksum Name does not exist, returning -1");
                        }
                        #endregion columns
